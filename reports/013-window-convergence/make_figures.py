...
for ax, (tag, label, extra) in zip(axes, (
    ...
    ax.set_xlabel("continued L-BFGS cycle")
...
fig.suptitle("An interior well requires both differences positive: "
             "the drift crosses zero and keeps deepening "
             "(no observable-level plateau in 24 cycles)",
             fontsize=10, y=1.02)
fig.tight_layout()
