...
| 004 | [Lattice hedgehog under the covariant G action](reports/004-lattice-clock/) | Statics survive on the lattice (gap 6.98, kin all-positive); Q1 of P240: no negative mode at the gradient-gated point (certified λ_min = +1.1e-3); honest negative: the local-quartic clock delocalizes (PR ×22) instead of ticking |
